...
public class Paciente {
    ...
    public Time getData_hr() {
        return data_hr;
    }

    public void setData_hr(Time data_hr) {
    ...
    public Paciente(int id, String nome, Date data_nasc, String sexo, String cpf, String rg, String est_civ, String etnia, String nome_resp, String nome_mae, String tel_prim, String tel_sec, String email, int fk_endereco, String convenio, String cns, Date valid_cart, Time data_hr, String observacoes) {
        this.id = id;
        this.nome = nome;
        this.data_nasc = data_nasc;
        this.sexo = sexo;
